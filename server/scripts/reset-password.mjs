...
//
// Usage : node scripts/reset-password.mjs <DATA_DIR> <NOUVEAU_MDP>
// (appelé par deploy/reset-password.sh, qui gère la génération et le restart).
...
if (!dataDir || !password) {
  console.error('Usage : node scripts/reset-password.mjs <DATA_DIR> <MOT_DE_PASSE>');
  process.exit(2);
}
