...
const PATHS: Record<string, ReactNode> = {
  ...
  eyedropper: (
    <>
      <path d="m13 8.5 2.5 2.5L8 18.5c-.8.8-2 1.3-3.5 1.5.2-1.5.7-2.7 1.5-3.5L13 8.5Z" />
      <path d="m11.5 7 5.5 5.5M14 4.5l2-2a2.1 2.1 0 0 1 3 0l2.5 2.5a2.1 2.1 0 0 1 0 3l-2 2L14 4.5Z" />
    </>
  ),
  textScan: (
    <>
